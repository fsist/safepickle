...
- Versioning support
- To reduce the number of classes & objects created, pickle-able types can declare a pickler in their companion object,
  and then it won't be autogenerated every single time that type is included by some other type. TODO provide a mixin
  trait for the companion object to make this easier.
